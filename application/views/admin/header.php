   ...
   <nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
      ...
      <ul class="nav navbar-nav">
       <li><a href="<?php echo base_url('/admin/index');?>"><i class="glyphicon glyphicon-book" style="font-size:15px;"></i>&nbsp;Daily Log</a></li>
        <li><li><a href="<?php echo base_url('/admin/users');?>"><i class="glyphicon glyphicon-user" style="font-size:15px;"></i>&nbsp;Users</a></li>
        <li><a href="<?php echo base_url('/admin/myaccount');?>"><i class="glyphicon glyphicon-cog" style="font-size:15px;"></i>&nbsp;My Account</a></li>
      </ul>
