    ...
    <div class="row">
      ...
      <div class="col-sm-2">
        <select id="dd_user" class="form-control">
          <option <?php echo ($currentUser== 0 ? "selected" : '');?> value="0">All</option>
           <?php foreach($user as $row){?>
          <option <?php echo ($currentUser==$row['id'] ? "selected" : '');?> value="<?php echo $row['id'];?>"><?php echo $row['fullname'];?></option>
          <?php } ?>
        </select>  
      </div>
    </div>
