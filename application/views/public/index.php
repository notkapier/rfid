        ...
        <div class="row">
          ...
          <div class="col-md-6" id="right_col" > 
              ...
              <?php if($this->session->flashdata('status')){ 
               ...
               if(!empty($test[0])){?>
                <div class="alert alert-warning alert-dismissible" role="alert">
                  ...
                  <strong>Message: </strong><?php echo $test[0];?>
                </div>
              <?php }
              } ?>
            ...
            <div class="button-group">
              <p><strong>AM</p>
             <button type="button" log="login_am" class="btn btn-default btn-lg btntype active_login">Login </button>
              <button type="button" log="logout_am" class="btn btn-default btn-lg btntype">Logout </button>
            </div>
            <br>
            <br>
            <div class="button-group">
              <p><strong>PM</p>
              <button type="button" log="login_pm" class="btn btn-default btn-lg btntype">Login </button>
              <button type="button" log="logout_pm" class="btn btn-default btn-lg btntype">Logout </button>
            </div>
            </div>
          </div>
        </div>
